  ...
  var stdin_default = {
    ...
    methods: {
      ...
      getPosition(position) {
        ...
        __f__("log", "at pages/task/task_detail/task_detail.vue:300", this.position, "position");
        if (map == null) {
          this.initMap();
        }
        if (map != null) {
       ...
       */
      changeMap(mapType) {
        __f__("log", "at pages/task/task_detail/task_detail.vue:344", "change-to-" + mapType);
       ...
       */
      addMarker(point) {
        var marker2 = L.marker([point.latitude, point.longitude]).addTo(map);
        marker2.bindPopup(`<view style="display:flex;flex-direction:column"><text>${point.description}</text>
