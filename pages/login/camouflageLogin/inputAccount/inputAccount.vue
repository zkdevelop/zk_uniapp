  ...
  <view class="inputAccountPage" style="padding: 0 15px 0 15px">
    <view class="inputAccountContent">
      ...
      <view class="inputAccountHeader">
        <!-- 推特logo -->
        <view class="inputAccountHeaderLeft"
          ><image
            @click="backToFirstPage"
            src="../../../../static/icon/closeimg.png"
            style="width: 20px; height: 20px"
          ></image
        ></view>
        <view class="inputAccountHeaderMiddle"
          ><image
            src="../../../../static/icon/X.png"
        ...
        <view style="text-align: left; margin-top: 30px">
          <text
            style="
              ...
              width: 75%;
            "
            >要开始使用，请先输入你的手机号码、邮箱地址或@用户名。</text
          >
        </view>
