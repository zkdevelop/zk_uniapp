<template>
  <view class="main-container">
    ...
    <view class="tab-bar" ref="tabBar">
      ...
      >
        <image
          :src="currentTab === index ? tab.icon_choice : tab.icon_nochoice"
          class="tab-icon"
          mode="aspectFit"
        ></image>
        <text :class="['tab-text', { active: currentTab === index }]">{{
          tab.label
        }}</text>
      </view>
    </view>
...
import Contacts from "../contacts/pages/contacts.vue";
...
export default {
  ...
  data() {
    return {
      ...
      tabs: [
        {
          icon_nochoice: "../../static/tabBar/pageno.png",
          icon_choice: "../../static/tabBar/pageyes.png",
          label: "首页",
        },
        {
          icon_nochoice: "../../static/tabBar/addressno.png",
          icon_choice: "../../static/tabBar/addressyes.png",
          label: "通讯录",
        },
        {
          icon_nochoice: "../../static/tabBar/taskno.png",
          icon_choice: "../../static/tabBar/taskyes.png",
          label: "任务",
        },
        {
          icon_nochoice: "../../static/tabBar/myno.png",
          icon_choice: "../../static/tabBar/myyes.png",
          label: "我的",
        },
      ],
    };
