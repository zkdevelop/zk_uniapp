					...
					<view class="" v-for="(item, index) in getItems(tabbarIndex)" :key="index">
						<view @click="goToDetail(index, tabbarIndex)" class="task_item">
							<view class="item_top">
								...
								<view><text
										:style="{background: getColor(item.type)}">{{getTypeString(item.type)}}</text>
								</view>
							</view>
							<view class="item_bottom">
								...
								<view style="margin-left: 7px;"><text
										style="line-height: 20px; text-align: center;">{{item.position}}</text></view>
							</view>
							<view class="item_bottom">
								<view>
		...
		methods: {
			initializeTasks() {
				...
				this.taskItem = [{
						...
						end_time: '2026.02.01',
						type: this.getTaskType('2024.05.03', '2026.02.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2026.03.01',
						type: this.getTaskType('2025.05.03', '2026.03.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2024.12.01',
						type: this.getTaskType('2024.06.01', '2024.12.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2024.05.01',
						type: this.getTaskType('2023.10.01', '2024.05.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2024.08.01',
						type: this.getTaskType('2023.12.01', '2024.08.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2024.11.01',
						type: this.getTaskType('2024.04.01', '2024.11.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2024.03.01',
						type: this.getTaskType('2023.09.01', '2024.03.01'),
						description: '描述1',
						key: '123456'
					},
					{
						...
						end_time: '2025.07.01',
						type: this.getTaskType('2025.01.01', '2025.07.01'),
						description: '描述1',
						key: '123456'
					},
				];
