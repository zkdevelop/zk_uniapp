  ...
  <view class="message" :class="[message.userType]"> 
    ...
    <view class="message-content" :class="{ 'self-message': message.userType === 'self' }">
      <view class="avatar-container"> 
              <image  src=" /static/message/defaultimg.png " class="avatar" mode="aspectFill"></image>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    // <image :src="message.userType === 'self' ? (message.avatar || userStore.state.avatar || '/static/message/defaultimg.png') : (message.avatar || '/static/message/defaultimg.png')" class="avatar" mode="aspectFill"></image>
    // 格式化时间戳为可读格式
